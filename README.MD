...
```
docker run  -d -p 8787:8787 -p 7777:7777  -p 8888:8888 -p 22:2222 picarus/datascience
```
...
```
docker run  -d -p 8787:8787 -p 7777:7777  -p 8888:8888 -p 22:2222 datascience
```
